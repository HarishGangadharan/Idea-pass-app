...
export interface CommonCustomControlProps {
  /**
...
export interface ActionCustomControlProps extends CommonCustomControlProps {
  label?: string;
  handleOnClick?(): void;
}

export interface ActionWithRulesCustomControlProps extends ActionCustomControlProps {
  /**
...
export interface SelectorEditorCustomControlProps extends CommonCustomControlProps {
  value?: string;
  handleOnChange?(value: any): void;
}

export interface CombinatorSelectorCustomControlProps
  extends SelectorEditorCustomControlProps {
  options: NameLabelList;
  rules?: Rule[];
}

export interface FieldSelectorCustomControlProps
  extends SelectorEditorCustomControlProps {
  options: NameLabelList;
}

export interface OperatorSelectorCustomControlProps
  extends SelectorEditorCustomControlProps {
  field?: string;
  options: NameLabelList;
}

export interface ValueEditorCustomControlProps
  extends SelectorEditorCustomControlProps {
  field?: string;
  operator?: string;
  customRules?: CustomRules;
